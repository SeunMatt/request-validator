...
import com.smattme.requestvalidator.validators.ArrayNotEmptyRuleValidator;
import com.smattme.requestvalidator.validators.DigitRuleValidator;
import com.smattme.requestvalidator.validators.EmailRuleValidator;
import com.smattme.requestvalidator.validators.InRuleValidator;
import com.smattme.requestvalidator.validators.LengthRuleValidator;
import com.smattme.requestvalidator.validators.MaxRuleValidator;
import com.smattme.requestvalidator.validators.MinRuleValidator;
import com.smattme.requestvalidator.validators.NumericRuleValidator;
import com.smattme.requestvalidator.validators.OptionalRuleValidator;
import com.smattme.requestvalidator.validators.RegexRuleValidator;
import com.smattme.requestvalidator.validators.RequiredIfRuleValidator;
import com.smattme.requestvalidator.validators.RequiredRuleValidator;
import com.smattme.requestvalidator.validators.RequiredWithAnyRuleValidator;
import com.smattme.requestvalidator.validators.RequiredWithRuleValidator;
import com.smattme.requestvalidator.validators.RequiredWithoutAnyRuleValidator;
import com.smattme.requestvalidator.validators.RequiredWithoutRuleValidator;
...
public class RequestValidator {
    ...
    public static List<String> validate(String jsonRequest, Map<String, String> rules,
            Map<String, Class<? extends RuleValidator>> ruleValidatorMap) {
    ...
    protected static List<String> evaluateAllRulesForAKey(Object document, Map<String, String> rulesMap, String key,
        ...
        /*
            These are rulesMap (e.g. max:250|min:10) to be applied to the key (e.g. firstName)
            under processing.
        ...
        */
        ...
        /*
            ...
            if the rule set contains `regex` rule,
            then double pipe character is the separator || otherwise, single | is used
        */
    ...
    protected static String evaluateSingleRule(Object document, String key, String ruleString, boolean optional,
        ...
        /*
            This will make the entire request available to validators that may want to check
            the value of other fields.
         */
        rule.setJsonPathObject(document);
    ...
    protected static boolean evaluateOptionalForRuleList(List<String> ruleList) {
        return ruleList.parallelStream().anyMatch(
                ruleString -> ruleString.startsWith("optional") || ruleString.startsWith("requiredIf") || ruleString.startsWith(
                        "requiredWith") || ruleString.startsWith("requiredWithAny") || ruleString.startsWith("requiredWithout")
